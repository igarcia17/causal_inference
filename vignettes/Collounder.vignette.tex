...
scatterplot(Z~X, data = when_xz_4, main ='Original case', regLine=TRUE, boxplots = FALSE, ylab = 'INK4a expression')
\end{lstlisting}
\begin{figure}[h]
...
\begin{figure}[h]
\includegraphics[width=6cm]{scatterplotradiationHIGH.png}
\centering
\end{figure}

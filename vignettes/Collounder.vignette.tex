...
sc1.comm.plusancestor <- function(b_yz, N, b_xz, b_xy, b_ax, reps = 30, e_x= 1, ...){
  ...
  ###Changes in X
  #p value         ######it is very obvious that it will always have a significant value
...
\begin{figure}[h]
\includegraphics[width=9cm]{histsc2.png}
\centering
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=9cm]{scatterplotOriginal.png}
\centering
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=10cm]{hist40.png}
\centering
\end{figure}

\begin{figure}[h]
\includegraphics[width=9cm]{scatterplot40.png}
\centering
\end{figure}
...
\end{lstlisting}
\begin{figure}[h]
\includegraphics[width=9cm]{mUVicor.png}
\centering
\end{figure}
...
\end{lstlisting}
\begin{figure}[h]
\includegraphics[width=11cm]{histextraoverY.png}
\centering
\end{figure}

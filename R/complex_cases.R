#_______________COMPLEX CASES __________________________________________________
library(simstudy)
library(dagitty)
library(rethinking)
...
#_______________BERCKSONS PARADOX ______________________________________________ 
...
#_______________SIMPSONS PARADOX _______________________________________________
...
#_______________BACKDOR CRITERIA________________________________________________
